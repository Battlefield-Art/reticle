...
description: Run npx @reticlehq/server init and let your coding agent wire Reticle into the project. What it changes, what it asks, and how to read its report.
...
reticle init (dry run, no files written)
  ...
  [✓] Install dependencies → package.json
      npm i -D @reticlehq/react@2.8.0 @reticlehq/vite-plugin@2.8.0
