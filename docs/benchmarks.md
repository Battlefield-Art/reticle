...
An observability layer that slows the app corrupts its own performance verdicts, so Reticle holds itself
to a budget: **total instrumentation overhead below 3% of main-thread time**, measured on the *hostile*
